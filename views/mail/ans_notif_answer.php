...
<p>Ваш ответ на обращение №<?= Html::encode($model->msg_id) ?>,
 назначенное Вам, отправлен на проверку модератору.</p>

<p>При необходимости это обращение будет направлено Вам на доработку.</p>
